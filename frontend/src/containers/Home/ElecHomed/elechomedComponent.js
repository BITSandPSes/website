        ...
        <ul className="list-unstyled">
          {list.map((item) => {
            return (
              <li>
                <Link
                  className="station-linker"
                  to={
                    "/" +
                    window.localStorage.getItem("stationNo") +
                    "/course/" +
                    item.slug
                  }
                >
                  <div className="my-3 mx-2 station-links">
                    <h5 className={"text-left elec-station-link-header"}>
                      {item.title}
                    </h5>
                    <h6 className="location-station text-left">
                      {"Number: " + item.number}
                    </h6>
                  </div>
                </Link>
...
class CourseDisplay extends Component {
  ...
  async componentDidMount() {
    ...
    let allCheck;
    window.sessionStorage.getItem("allCheck") === "0"
      ? (allCheck = false)
      : (allCheck = true);
        ...
        <div className="container">
          <div className="row row-contents justify-content-center">
            <div className={"col-11 elec-search-box"}>
              <h1 className="search-heading text-left text-md-center">
                Search.
              </h1>
              <h6 className="elec-search-sub-text text-left text-md-center d-none d-md-block">
                Find the course you are looking for according to the priorities
                you set.
                <br />
                Search by name or courseNo, filter according to your
                preferences.
              </h6>
              ...
              <div className="search-bar-hold">
                <Form className="row " autoComplete="off">
                    ...
                    <FormGroup check inline className="mt-4">
                      <Label check className="elec-label-font">
                        <Input
                          ...
                          onChange={this.changeSearchMethod}
                        />{" "}
                        By Name
                      </Label>
                    </FormGroup>
                  ...
                  <div className="col-6 col-md-4 text-right text-md-right padding-remover">
                    <Button
                      className="elec-search-button mt-4 ml-md-3"
                      onClick={(event) => {
                        this.handleEmptytype(event);
                      }}
                      type="submit"
                    >
                      Search
        ...
        <div className="container d-none d-lg-block">
          <div className="row row-contents justify-content-center align-items-start">
            <div className="col-4 filter-box text-left">
              ...
              <Form className="row ml-3" autoComplete="off">
                ...
                {this.state.courses.map((course) => {
                  return (
                    <CheckBox
                      {...course}
                      handleCheckChild={this.handleCheckChild}
                    />
                  );
                })}
              </Form>
              <Link>
                <Button
                  className="ml-3 apply-filter-button mb-3 mt-2 pb-2"
                  to={
                    window.localStorage.getItem("stationNo") + "/home/filtered"
                  }
                >
                  Apply
                </Button>
        ...
        <div className="row row-contents d-block d-lg-none justify-content-center">
          <div className="filter-box-small">
            ...
            <div className="offset-2 col-8 offset-sm-3 col-sm-6">
              <Button
                className="btn btn-primary small-filter-chooser mb-3"
                onClick={this.togglefiltersmall}
              >
                ...
                <div className="filter-pop-up">
                  <div className="row">
                    <div className="col-12 text-right">
                      <Button
                        onClick={this.togglefiltersmall}
                        className="btn btn-primary pop-up-close my-2 mr-3"
                      >
            ...
            <div className="col-12">
              <Link>
                <Button
                  className="apply-filter-button mb-4 mt-2 pb-2"
                  to={
                    window.localStorage.getItem("stationNo") + "/home/filtered"
                  }
                >
